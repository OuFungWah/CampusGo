package com.example.fungwah.campusgo.command.database.dao;
...
import com.example.fungwahtools.database.helper.BaseDatabaseHelper;
...
public class BaseDao {
    ...
    public BaseDao(Context context) {
        helper = new CampusHelper(context, CampusHelper.DB_NAME, null, 5);
    }
